import 'package:app_7/presentation/screens/contact_us/widgets/buildText.dart';
import 'package:app_7/presentation/screens/contact_us/widgets/expansion_tile_item.dart';
import 'package:app_7/presentation/screens/contact_us/widgets/socialIcons_row.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('تواصل معنا',
                          style: TextStyle(color: ColorManager.primary, fontWeight: FontWeight.w600, fontSize: 30)),
                    ],
                  ),
                ),
              ),
