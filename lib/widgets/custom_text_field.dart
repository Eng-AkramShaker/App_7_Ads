    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: widget.hintStyle != null ? widget.hintStyle : TextStyle(color: ColorManager.borderColor,fontSize: widget.fontSize),
          ...
          labelStyle: widget.lableStyle?? TextStyle(color: ColorManager.b_69 ,),
